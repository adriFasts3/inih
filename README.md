...
- Drops compile-time options for multiline values and inline comments; comments are always enabled.
- Drops BOM handling.
- Uses consistent return codes and asserts on NULL arguments.
